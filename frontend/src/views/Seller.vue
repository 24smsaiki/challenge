        ...
        <form class="form-signin">
          ...
          <div class="parent">
            <div>
              ...
              />
              <p class="messageErrors mb-3 ml-0" v-if="errors?.shopEmailContact">
              {{ errors.shopEmailContact }}
            </p>
            </div>
            <div>
              ...
              />
              <p class="messageErrors mb-3 ml-0" v-if="errors?.shopPhoneContact">
              {{ errors.shopPhoneContact }}
            </p>
            </div>
          </div>
