...
const onSubmit = (e) => {
  ...
  if (isFormValid()) {
    if (form.value.id) {
      ProductsLogic.updateProduct(form.value.id, form.value).then(
        (response) => {
      ...
      ProductsLogic.createProduct(form.value).then((response) => {
        isEditing.value = false;
    ...
    >
      ...
      <div class="-mx-3 md:flex mb-6">
        ...
        <div class="md:w-1/3 px-3">
          ...
          />
          <p class="messageErrors" v-if="errors.stockQuantity">
            {{ errors.stockQuantity }}
          </p>
        </div>
      </div>
      <div class="-mx-3 md:flex mb-6">
        <div class="md:w-full px-3">
          ...
          <textarea
            ...
            @input="isDescription"
          />
          <p class="messageErrors" v-if="errors.description">
            {{ errors.description }}
          </p>
        </div>
      </div>
