...
const isIsPaid = () => {
    ...
    if(isPaid.length < 3) {
        errors.isPaid = "Le statut de paiement doit contenir au moins 3 caractères.";
    } else {
        errors.isPaid = "";
    }
};
...
<template class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
    <Header />
    <Table :cantEditing="true" :data="orders" :columns="columns" @onEdit="onEdit" :isEditing="isEditing" @editForm="editForm" />
